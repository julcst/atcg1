...
CylinderShape::CylinderShape(PrivatePtr<opg::Scene> _scene, const opg::Properties &_props) :
...
void CylinderShape::initializePipeline(opg::RayTracingPipeline *pipeline, opg::ShaderBindingTable *sbt)
{
    auto ptx_filename = opg::getPtxFilename(OPG_TARGET_NAME, "cylinder.cu");
